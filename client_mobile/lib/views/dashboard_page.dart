...
import 'main_screen.dart'; // Aynı klasörde oldukları için sorunsuz bulacak
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final List<Map<String, dynamic>> _onboardingData = [
    {
      "title": "Welcome to\nUmay Sentinel",
      "description": "Take control of your network traffic and ensure full protection against cyber threats.",
      "icon": Icons.security,
      "color": Colors.blueAccent,
    },
    {
      "title": "Real-Time\nMonitoring",
      "description": "See all devices connected to your network instantly and analyze packets.",
      "icon": Icons.radar,
      "color": Colors.cyanAccent,
    },
    {
      "title": "WireGuard Tunnel\nReady!",
      "description": "Your secure connection keys have been successfully generated by the server. You are ready to start.",
      "icon": Icons.vpn_key,
